...
If you reference any work from this repository, please use the citation information provided in each paper's directory or the [CITATION.cff](CITATION.cff) file.

## Contact

- **Author:** Evgenii Kniazev
- **GitHub:** [@keugenek](https://github.com/keugenek)

## License

Papers and text content are licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
Code and supplementary materials are licensed under [MIT](LICENSE).
